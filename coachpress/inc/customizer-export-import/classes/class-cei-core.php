...
final class CEI_Core {
	...
	// {
	// 	load_plugin_textdomain( 'customizer-export-import', false, basename( CEI_THEME_DIR ) . '/lang/' );
	// }
	...
	{
		// Register
		wp_register_style( 'cei-css', CEI_THEME_URL . '/css/customizer.css', array(), CEI_VERSION );
		wp_register_script( 'cei-js', CEI_THEME_URL . '/js/customizer.js', array( 'jquery' ), CEI_VERSION, true );
	...
	{
		require_once CEI_THEME_DIR . '/classes/class-cei-control.php';

		// Add the export/import section.
		$wp_customize->add_section( 'cei-section', array(
			'title'	   => __( 'Export/Import', 'coachpress' ),
			'priority' => 10000000,
		));
	...
	static private function _import( $wp_customize )
	{
		...
		require_once CEI_THEME_DIR . '/classes/class-cei-option.php';
