...
define( 'CEI_THEME_DIR', get_template_directory() . '/inc/customizer-export-import' );
define( 'CEI_THEME_URL', get_template_directory_uri() . '/inc/customizer-export-import' );

/* Classes */
require_once CEI_THEME_DIR . '/classes/class-cei-core.php';

/* Actions */
// Don't need to load text domain since it's not a plugin.
